    ...
    <div className="w-full mx-15">
      <div className="mt-[40px] mb-[20px] w-full mx-auto flex flex-wrap gap-x-[40px]">
        {products.map((product) => (
          <div
            key={product.id}
            className="w-[180px] h-[280px] cursor-pointer hover:shadow-xs"
          >
            <div className="w-[170px] h-[170px] rounded-[10px] bg-[#F2F2F1] flex justify-center items-center overflow-hidden group">
              <img
                src={product.image}
