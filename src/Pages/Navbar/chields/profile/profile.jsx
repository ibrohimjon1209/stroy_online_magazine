  ...
  return (
    ...
    <div className="mb-10 gap-[20px] sm:gap-0 sm:my-[20px] flex flex-col items-center justify-center w-full">
      ...
      <div className="flex profile_md:w-[93%] w-[90%] mx-auto">
        <Sidebar lang={lang} isUserSignIn={isUserSignIn} setUserSignIn={setUserSignIn} set_user_s={set_user} user_s={user} edit_profile_open={edit_profile_open} set_edit_profile_open={set_edit_profile_open} set_is_logout_open={set_is_logout_open} />
