    ...
    <div className="flex flex-col w-full sm:mb-0 mb-21">
      ...
      <div className="w-full mx-auto p-5 sm:p-6 sm:mt-0 mt-16 pt-[20px] sm:pt-[35px]">
        {visibleProducts.length == 0 ? (
          <div className="w-full mt-[90px] mb-[6%] flex flex-col justify-center items-center">
            <img
              src={no_basket}
              alt="No basket"
              className="w-[180px] sm:w-[250px] hover:scale-[103%] transition-all duration-[0.3s]"
            />
            <h1 className="ml-[40px] w-full mt-[8px] text-[17px] sm:text-[25px] text-center text-gray-800 font-[600] font-inter">
              {lang === "uz"
                ? "Savatchangiz bo'sh"
                : lang === "en"
                ...
                <div className="flex-1">
                  ...
                  <div className="flex justify-between">
                    <div className="flex items-center mt-4 sm:mt-10">
                      {/* Chap tarafdagi minus/trash tugmasi */}
                      {product.quantity > 1 ? (
                        <button
                          onClick={() =>
                            decreaseQuantity(
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    <p className="font-inter font-[500] text-[14px] xs:text-[16px] leading-[22px] text-black bg-yellow-100 rounded-lg p-2 xs:p-3 mt-[10px]">{lang == "uz"
                ...
                <Link
                  ...
                  className={`sm:w-[87%] w-[90%] absolute flex items-center justify-center py-4 sm:mt-[25%] mt-[4%] ${hasSelectedProducts
