...
const Terms_main = () => {
  return (
    <div className="w-full h-full flex flex-col mb-[35px]">
      <div className="sticky w-full h-[65px] fixed top-0 z-50">
        <div className="bg-[#DCC38B] flex items-center gap-[10px] w-full h-full font-inter font-[600] text-[17px] sm:text-[20px] leading-[22px] text-black flex items-center pl-[13px] sm:pl-[50px]">
          ...
          <p>Foydalanuvchi shartnomasi</p>
        </div>
      </div>
      <div className="max-w-[90%] mx-auto mt-[20px] sm:mt-[35px] mx-auto font-inter font-[600] text-[15px] leading-[22px] text-black text-justify">
